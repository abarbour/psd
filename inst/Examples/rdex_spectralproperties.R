...
##
## An example using the MAGSAT dataset
##
data(magsat)
tapinit <- 15 # tapers
dt <- 1 # 1/km
...
ats <- prewhiten(ts(magsat$clean, deltat=dt), plot=FALSE)$prew.lin
...
plot(frq, relp,
     ...
     main="MAGSAT Spectral Resolution and Uncertainty")
lines(frq, relp)
