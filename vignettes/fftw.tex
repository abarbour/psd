...
\hlcomment{    ## plot the benchmark data 1/sqrt(n) standard errors [assumes N(0,1)]}
    g <- \hlfunctioncall{ggplot}(data = allbench.df.mlt, \hlfunctioncall{aes}(x = \hlfunctioncall{log10}(num_dat), y = \hlfunctioncall{log2}(value), 
        ...
        \hlfunctioncall{theme_bw}() + \hlfunctioncall{ylim}(\hlfunctioncall{c}(-11, 11)) + \hlfunctioncall{xlim}(\hlfunctioncall{c}(0.5, 6.5)) + \hlfunctioncall{ggtitle}(\hlfunctioncall{sprintf}(\hlstring{"DFT benchmarks of %s length series"}, 
        \hlfunctioncall{toupper}(lentyp)))
