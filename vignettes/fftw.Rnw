...
\begin{figure}[htb!]
\begin{center}
<<eval=FALSE, echo=TRUE, fig=TRUE, label="Plot highly composite results.">>=
pltbench("even")
@
...
\begin{figure}[htb!]
\begin{center}
<<eval=FALSE, echo=TRUE, fig=TRUE,  label="Plot non highly composite results.">>=
