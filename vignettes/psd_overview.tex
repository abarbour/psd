...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Stage\ \ 0 est. (pilot) \\\#\# 	environment\ \ ** .psdEnv **\ \ refreshed\\\#\# detrending (and demeaning)\\\#\# Stage\ \ 1 est. (Ave. S.V.R. -17.6 dB) \\\#\# Stage\ \ 2 est. (Ave. S.V.R. -34.3 dB) \\\#\# Stage\ \ 3 est. (Ave. S.V.R. -45.1 dB) \\\#\# Normalized\ \ single-sided PSD\ \ (PSD)\ \ to single-sided PSD for sampling-freq.\ \ 1}}\begin{alltt}
\hlstd{psdc} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(magnet}\hlopt{$}\hlstd{clean)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Stage\ \ 0 est. (pilot) \\\#\# 	environment\ \ ** .psdEnv **\ \ refreshed\\\#\# detrending (and demeaning)\\\#\# Stage\ \ 1 est. (Ave. S.V.R. -16.6 dB) \\\#\# Stage\ \ 2 est. (Ave. S.V.R. -35.1 dB) \\\#\# Stage\ \ 3 est. (Ave. S.V.R. -43.9 dB) \\\#\# Normalized\ \ single-sided PSD\ \ (PSD)\ \ to single-sided PSD for sampling-freq.\ \ 1}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Stage\ \ 0 est. (pilot) \\\#\# 	environment\ \ ** .psdEnv **\ \ refreshed\\\#\# detrending (and demeaning)\\\#\# Stage\ \ 1 est. (Ave. S.V.R. -18.2 dB) \\\#\# Stage\ \ 2 est. (Ave. S.V.R. -35.7 dB) \\\#\# Stage\ \ 3 est. (Ave. S.V.R. -37.4 dB) \\\#\# Normalized\ \ single-sided PSD\ \ (PSD)\ \ to single-sided PSD for sampling-freq.\ \ 1}}\begin{alltt}
...
##  $ taper            : atomic  171 171 170 170 170 169 169 168 168 168 ...
##   ..- attr(*, "n_taper_limits")= num  1 512
##   ..- attr(*, "taper_positions")= logi NA
##   ..- attr(*, "span_was_set")= logi FALSE
##   ..- attr(*, "n_taper_limits_orig")= num  1 512
##  $ stderr.chi.lower : num  -0.63 -0.63 -0.632 -0.632 -0.632 ...
##  $ stderr.chi.upper : num  0.674 0.674 0.676 0.676 0.676 ...
##  $ stderr.chi.median: num  0.229 0.229 0.23 0.23 0.23 ...
##  $ stderr.chi.approx: atomic  0.229 0.229 0.23 0.23 0.23 ...
##   ..- attr(*, "n_taper_limits")= num  1 512
##   ..- attr(*, "taper_positions")= logi NA
##   ..- attr(*, "span_was_set")= logi FALSE
##   ..- attr(*, "n_taper_limits_orig")= num  1 512
##  $ resolution       : atomic  0.336 0.336 0.334 0.334 0.334 ...
##   ..- attr(*, "n_taper_limits")= num  1 512
##   ..- attr(*, "taper_positions")= logi NA
##   ..- attr(*, "span_was_set")= logi FALSE
##   ..- attr(*, "n_taper_limits_orig")= num  1 512
##  $ dof              : atomic  342 342 340 340 340 338 338 336 336 336 ...
##   ..- attr(*, "n_taper_limits")= num  1 512
##   ..- attr(*, "taper_positions")= logi NA
##   ..- attr(*, "span_was_set")= logi FALSE
##   ..- attr(*, "n_taper_limits_orig")= num  1 512
##  $ bw               : atomic  0.168 0.168 0.167 0.167 0.167 ...
##   ..- attr(*, "n_taper_limits")= num  1 512
##   ..- attr(*, "taper_positions")= logi NA
##   ..- attr(*, "span_was_set")= logi FALSE
##   ..- attr(*, "n_taper_limits_orig")= num  1 512
...
\hlkwd{plot}\hlstd{(frq, relp,}
     ...
     \hlkwc{ylim}\hlstd{=yl}\hlkwb{<-}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{35}\hlstd{),}
     \hlkwc{type}\hlstd{=}\hlstr{"h"}\hlstd{,} \hlkwc{xaxs}\hlstd{=}\hlstr{"i"}\hlstd{,} \hlkwc{yaxs}\hlstd{=}\hlstr{"i"}\hlstd{,}
