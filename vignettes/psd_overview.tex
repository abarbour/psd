...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loaded psd (0.4.0) -- Adaptive multitaper spectrum estimation.}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Stage\ \ 1 est. (Ave. S.V.R. -23.8 dB)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Stage\ \ 2 est. (Ave. S.V.R. -38.2 dB)}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Stage\ \ 3 est. (Ave. S.V.R. -36.3 dB)}}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following objects are masked from 'package:stats':\\\#\# \\\#\#\ \ \ \  filter, poly}}\begin{alltt}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:stats':\\\#\# \\\#\#\ \ \ \  acf}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:base':\\\#\# \\\#\#\ \ \ \  sample}}\begin{alltt}
\hlfunctioncall{print}(Bspec <- \hlfunctioncall{bspec}(\hlfunctioncall{ts}(magnet$clean)))
\end{alltt}
\begin{verbatim}
...
\hlfunctioncall{plot}(frq, relp, main = \hlstring{"Percent change in spectral resolution"}, col = \hlstring{"light grey"}, 
    ylim = yl <- \hlfunctioncall{c}(0, 35), type = \hlstring{"h"}, xaxs = \hlstring{"i"}, yaxs = \hlstring{"i"}, ylab = \hlstring{"dB"}, 
...
\hlfunctioncall{boxplot}(relp, range = 0, main = \hlfunctioncall{sprintf}(\hlstring{"%.01f"}, \hlfunctioncall{median}(relp)), axes = FALSE, 
    ylim = yl, yaxs = \hlstring{"i"}, notch = TRUE)
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/HIST3} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlfunctioncall{suppressWarnings}(\hlfunctioncall{symnum}(cT <- \hlfunctioncall{cor}(StgTap)))
\end{alltt}
\begin{verbatim}
##               
## [1,] 1        
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlfunctioncall{suppressWarnings}(\hlfunctioncall{symnum}(cP <- \hlfunctioncall{cor}(StgPsd)))
\end{alltt}
\begin{verbatim}
##               
## [1,] 1        
...
##  [4] MASS_7.3-27        RColorBrewer_1.0-5 RSEIS_3.2-1       
##  [7] Rwave_2.1          RPMG_2.1-4         psd_0.4-0         
## [10] fftw_1.0-3         knitr_1.2         
## 
## loaded via a namespace (and not attached):
##  [1] colorspace_1.2-2 dichromat_2.0-0  digest_0.6.3     evaluate_0.4.4  
##  [5] formatR_0.8      gtable_0.1.2     labeling_0.2     lattice_0.20-15 
##  [9] munsell_0.4      plyr_1.8         proto_0.3-10     reshape2_1.2.2  
## [13] scales_0.2.3     stringr_0.6.2    zoo_1.7-10
\end{verbatim}
\end{kframe}
\end{knitrout}
