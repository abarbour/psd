...
\hlfunctioncall{text}(0.22, 35, \hlstring{"\hlfunctioncall{Bayesian} (bspec)"}, cex = 0.9)
\hlfunctioncall{polygon}(psppu$xx, psppu$yy, col = \hlstring{"dark grey"}, border = \hlstring{"black"}, lwd = 0.2)
\hlfunctioncall{text}(0.15, 6, \hlstring{"Light: adaptive\textbackslash{}ntaper refinement\textbackslash{}\hlfunctioncall{n}(pspectrum)"}, cex = 0.9)
\hlfunctioncall{polygon}(pspau$xx, pspau$yy, col = \hlstring{"light grey"}, border = \hlstring{"black"}, lwd = 0.2)
\hlfunctioncall{text}(0.4, 22, \hlstring{"Dark: Uniform\textbackslash{}\hlfunctioncall{ntapering} (psdcore)"}, cex = 0.9)
\end{alltt}
\end{kframe}
...
\hlfunctioncall{plot}(frq, relp, col = \hlstring{"light grey"}, ylim = \hlfunctioncall{dB}(\hlfunctioncall{c}(1, 5)), type = \hlstring{"h"}, xaxs = \hlstring{"i"}, 
    yaxs = \hlstring{"i"}, ylab = \hlstring{"dB"}, xlab = \hlstring{"frequency, 1/km"}, main = \hlstring{"Project MAGNET Spectral Resolution"})
...
##  [1] bspec_1.4          ggplot2_0.9.3      signal_0.7-2      
##  [4] MASS_7.3-23        RColorBrewer_1.0-5 RSEIS_3.0-9       
##  [7] Rwave_2.0          RPMG_2.1-4         psd_0.2-0         
## [10] fftw_1.0-3         knitr_1.0.5       
## 
## loaded via a namespace (and not attached):
##  [1] Peaks_0.2        colorspace_1.2-1 dichromat_2.0-0  digest_0.6.2    
