...
%% Project MAGNET data
\input{figure/LoadProjectMAGNETdata.tex}
The format of the data set is a \Rcmd{data.frame} with four
sets of information:
%%
\input{figure/ShowcontentsofProjectMAGNET.tex}
...
\input{figure/Naivespectrumestimation.tex}
...
\input{figure/LoadRSEISpackage.tex}
...
\input{figure/Structureofmtapspecpsd.tex}
...
\input{figure/Comparativespectramtapspecvspspectrum.tex}
...
(or reciprocally): 
\input{figure/Interpolateresults.tex}
...
\input{figure/Summarizeregressionstatistics.tex}
...
\input{figure/Computespectralproperties.tex}
...
\input{figure/Getadaptivehistory.tex}
Followed by some trivial manipulation:
\input{figure/andmanipulateitabit.tex}
