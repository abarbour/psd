...
%% libload
<<eval=TRUE, eval=TRUE, label="Load library.">>=
library(rlpSpec)
@ 
...
%% magsat data
<<eval=TRUE, eval=TRUE, label="Load MAGSAT data.">>=
data(magsat)
@ 
The format of the data set is a \Rcmd{data.frame} with four
sets of information:
%%
<<eval=TRUE, eval=TRUE, label="Show contents of MAGSAT.">>=
names(magsat)
@ 
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, fig=TRUE, echo=TRUE, label=RAWvCLEAN>>=
...
\begin{center}
%% magsat compare
<<eval=TRUE, echo=TRUE, fig=TRUE,  label=MAGSATNAIVE>>=
ntap <- psdc$taper
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig=TRUE, fig.height=3.5, fig.width=6.5, label=ARFIT>>=
atsar <- prewhiten(ats, AR.max=100, verbose=FALSE)
@
<<eval=TRUE, echo=TRUE, fig=TRUE, fig.height=3, fig.width=4.5, label=ARPSD>>=
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig=TRUE, fig.width=6.0, fig.height=5.4, label=RSEIS>>=
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=FALSE, fig=TRUE, fig.width=6, fig.height=5, label=RSEISvsRLP1>>=
print(g1 + scale_colour_gradient2(mid="light grey") + theme_bw() + 
	ggtitle("Regression of mtapspec against psdcore"))
@
<<eval=TRUE, echo=FALSE, fig=TRUE, fig.width=6, fig.height=2.5, label=RSEISvsRLP2>>=
print(g2 + theme_bw() +
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig=TRUE, fig.width=5, fig.height=4.5, label=SPECERR>>=
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig=TRUE, fig.width=6, fig.height=5.5, label=MAGERR>>=
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig=TRUE, fig.width=7, fig.height=4, label=MAGRES>>=
frq <- Aspec$freq
psd <- dB(Aspec$spec)
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=FALSE, fig=TRUE, fig.width=6, fig.height=4, label=HIST1>>=
seqcols <- 1:numit
itseq <- seqcols - 1
...
@
<<eval=TRUE, echo=FALSE, fig=TRUE, fig.width=6, fig.height=3.5, label=HIST2>>=
par(xpd=TRUE)
...
<<eval=TRUE, echo=TRUE, label=SYMCORR>>=
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=FALSE, fig=TRUE, fig.width=6, fig.height=6, label=XCORP>>=
