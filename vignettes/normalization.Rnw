...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig.width=6, fig.height=3.5, label=PSD>>=
...
\begin{figure}[htb!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig.width=6, fig.height=3.5, label=PSD2>>=
    # decibel function
...
\begin{figure}[h!]
\begin{center}
<<eval=TRUE, echo=TRUE, fig.width=6, fig.height=3.5, label=NORMS>>=
