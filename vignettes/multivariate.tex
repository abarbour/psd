...
\hlstd{coh_base} \hlkwb{<-} \hlkwd{spec.pgram}\hlstd{(wipp30[,} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{)],} \hlkwc{spans} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{11}\hlstd{),} \hlkwc{fast} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{plot} \hlstd{=} \hlnum{FALSE}\hlstd{)}\hlopt{$}\hlstd{coh}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlstd{phase_base} \hlkwb{<-} \hlkwd{spec.pgram}\hlstd{(wipp30[,} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{)],} \hlkwc{spans} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{11}\hlstd{),} \hlkwc{fast} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{plot} \hlstd{=} \hlnum{FALSE}\hlstd{)}\hlopt{$}\hlstd{phase}
\end{alltt}
\end{kframe}
\end{knitrout}
