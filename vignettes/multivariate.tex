...
\hlstd{wipp30} \hlkwb{<-} \hlkwd{as.matrix}\hlstd{(wipp30[,} \hlopt{-}\hlnum{1}\hlstd{])} \hlcom{# remove the time column for this vignette}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{mv} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{0L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{plot} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{output_column} \hlstd{=} \hlnum{1}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{mn} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{0L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{)}   \hlcom{# minimum number }
\hlstd{mx} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=}\hlopt{-}\hlnum{1L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{)}   \hlcom{# maximum number}
\hlstd{c1} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{1L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{)}   \hlcom{# column 1}
\hlstd{c2} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{2L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{)}   \hlcom{# column 2}
\hlstd{c3} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{3L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{)}   \hlcom{# column 3}
\end{alltt}
\end{kframe}
\end{knitrout}
\begin{knitrout}
...
\hlstd{one_val} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{0L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{,}
...
\begin{alltt}
\hlkwd{par}\hlstd{(}\hlkwc{mar} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{0}\hlstd{),} \hlkwc{mgp} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,} \hlnum{0.5}\hlstd{,} \hlnum{0}\hlstd{))}
\hlstd{vec_val} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{0L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{,}
                 \hlkwc{niter} \hlstd{=} \hlnum{0}\hlstd{,} \hlkwc{ntap} \hlstd{=} \hlkwd{as.tapers}\hlstd{(}\hlnum{1}\hlopt{:}\hlstd{(}\hlkwd{nrow}\hlstd{(wipp30)} \hlopt{%/%} \hlnum{2}\hlstd{)} \hlopt{%/%} \hlnum{7} \hlopt{+} \hlnum{7}\hlstd{),} \hlkwc{plot} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}
...
\item  $ coherence_{xy}  = |G_{xy}|^2 / (G_{xx} * G_{yy})$

\item  $ phase_{xy} = Arg(G_{xy})$

\item  \href{https://en.wikipedia.org/wiki/Cramer%27s_rule}{Cramer's Rule} is used to solve for the transfer function with the \Rcmd{pspec} as the input.

\item $ gain = Mod(transfer) $
\item $ phase = Arg(transfer) $
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{spec} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{0L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{)}\hlopt{$}\hlstd{pspec}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{coh} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{0L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{,}
                 \hlkwc{niter} \hlstd{=} \hlnum{0}\hlstd{,} \hlkwc{ntap.init} \hlstd{=} \hlnum{11}\hlstd{)}\hlopt{$}\hlstd{coh}
\hlstd{coh_base} \hlkwb{<-} \hlkwd{spec.pgram}\hlstd{(wipp30,} \hlkwc{spans} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{11}\hlstd{),} \hlkwc{fast} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{plot} \hlstd{=} \hlnum{FALSE}\hlstd{)}\hlopt{$}\hlstd{coh}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{phase} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlnum{0L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{,}
                 \hlkwc{niter} \hlstd{=} \hlnum{0}\hlstd{,} \hlkwc{ntap.init} \hlstd{=} \hlnum{11}\hlstd{)}\hlopt{$}\hlstd{phase}
\hlstd{phase_base} \hlkwb{<-} \hlkwd{spec.pgram}\hlstd{(wipp30,} \hlkwc{spans} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{11}\hlstd{),} \hlkwc{fast} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{plot} \hlstd{=} \hlnum{FALSE}\hlstd{)}\hlopt{$}\hlstd{phase}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{transfer} \hlkwb{<-} \hlkwd{pspectrum}\hlstd{(wipp30,} \hlkwc{riedsid_column}\hlstd{=} \hlopt{-}\hlnum{1L}\hlstd{,} \hlkwc{verbose} \hlstd{=} \hlnum{FALSE}\hlstd{)}\hlopt{$}\hlstd{transfer}
