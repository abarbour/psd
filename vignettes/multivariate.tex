...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(vec\_val\$taper): object 'vec\_val' not found}}\end{kframe}
\end{knitrout}
...
\item  \href{https://en.wikipedia.org/wiki/Cramer%27s_rule}{Cramer's Rule} is used to solve for the transfer function with the pspec as the input.
