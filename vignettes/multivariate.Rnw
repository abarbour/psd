...
@
<<eval=TRUE, echo=FALSE, label="Taperplot", fig.height = 4.8>>=
...
<<eval=TRUE, echo=TRUE, label="taperspecification", fig.height = 3>>=
...
<<eval=TRUE, echo=TRUE, label="taperspecification2", fig.height = 3>>=
par(mar = c(3, 4, 1, 0), mgp = c(2, 0.5, 0))
...
<<eval=TRUE, echo=FALSE, label="cohbaplot", fig.height=3.3>>=
...
@
<<eval=TRUE, echo=FALSE, label="cohetplot", fig.height=3.3>>=
par(mar = c(3, 3, 2, 0), mgp = c(2, 1, 0))
...
<<eval=TRUE, echo=FALSE, label="phasebaplot", fig.height=3.3>>=
par(mar = c(3, 3, 2, 0), mgp = c(2, 1, 0))
...
legend('bottomleft', 
       ...
       col = c('black', 'red'), lty = 1)
@
<<eval=TRUE, echo=FALSE, label="phaseetplot", fig.height=3.3>>=
par(mar = c(3, 3, 2, 0), mgp = c(2, 1, 0))
...
<<eval=TRUE, echo=FALSE, label="transfergainplot", fig.height=3.3>>=
...
<<eval=TRUE, echo=TRUE, label="transferphase", fig.height=3.3>>=
phase <- Arg(transfer)
@
<<eval=TRUE, echo=FALSE, label="transferphaseplot", fig.height=3.3>>=
par(mar = c(3, 3, 2, 0), mgp = c(2, 1, 0))
